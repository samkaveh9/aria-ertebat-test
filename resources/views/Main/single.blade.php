...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/main/js/swipebox/src/css/swipebox.min.css">
                ...
                <div id="content" class="col-sm-9">
                    <div itemscope >
                        ...
                        <div class="row product-info">
                            <div class="col-sm-6">
                                <div class="image"><img class="img-responsive" itemprop="image" id="zoom_01" src="{{ asset('storage/'. $product->image) }}" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" data-zoom-image="image/product/macbook_air_1-600x900.jpg" /> </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <ul class="price-box">
                                    <li class="price" itemprop="offers" itemscope > <span itemprop="price">{{ $product->price }} تومان<span itemprop="availability" content="موجود"></span></span></li>
                                    <li></li>
                                </ul>
                                <div id="product">
                        ...
                        <div class="owl-carousel related_pro">
                            @foreach($latestProducts as $latestProduct)
                                <div class="product-thumb">
                                    <div class="image">
                                        <a href="{{ route('product.single', $latestProduct->id) }}">
                                            <img src="{{ asset('storage/'.$latestProduct->image) }}" alt="تبلت ایسر" title="تبلت ایسر" class="img-responsive" />
                                        </a>
                                    </div>
                                    <div class="caption">
                                        <h4><a href="{{ route('product.single', $latestProduct->id) }}">{{ $latestProduct->title }}</a></h4>
                                        <p class="price"> <span class="price-new">{{ $latestProduct->price }} تومان</span> </p>
                    ...
                    <div class="side-item">
                        @foreach($specialProducts as $specialProduct)
                            <div class="product-thumb clearfix">
                                <div class="image">
                                    <a href="{{ route('product.single', $specialProduct->id) }}">
                                        <img src="{{ asset('storage/'. $specialProduct->image) }}"  class="img-responsive" />
                                    </a>
                                </div>
                                <div class="caption">
                                    <h4><a href="{{ route('product.single', $specialProduct->id) }}">{{ $specialProduct->title }}</a></h4>
                                    <p class="price"> <span class="price-new">{{ $specialProduct->price }} تومان</span></p>
                                </div>
                            </div>
                        @endforeach
                    </div>
...
<script type="text/javascript" src="/main/js/swipebox/lib/ios-orientationchange-fix.js"></script>
<script type="text/javascript" src="/main/js/swipebox/src/js/jquery.swipebox.min.js"></script>
